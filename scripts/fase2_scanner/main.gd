...
func _build_world() -> void:
	...
	terrain.z_index = -10
	add_child(terrain)
	_create_platform(Vector2(120, 590), Vector2(240, 60), false)
	_create_platform(Vector2(620, 640), Vector2(460, 60), false)
	_create_platform(Vector2(1140, 630), Vector2(280, 60), false)
	_create_platform(Vector2(340, 422), Vector2(210, 24), true)
	_create_platform(Vector2(650, 312), Vector2(230, 24), true)
	_create_platform(Vector2(850, 442), Vector2(180, 24), true)
	_create_platform(Vector2(1090, 362), Vector2(190, 24), true)
	_create_platform(Vector2(910, 572), Vector2(180, 24), true)
	_create_platform(Vector2(-20, 360), Vector2(40, 720), false)
	_create_platform(Vector2(1300, 360), Vector2(40, 720), false)
	_create_hazard(Vector2(310, 620), Vector2(150, 38))
	_create_hazard(Vector2(965, 655), Vector2(90, 36))
	...
	portal.position = Vector2(1190, 560)
	portal.entered.connect(_on_portal_entered)
	add_child(portal)
	player = PLAYER_SCENE.instantiate()
	player.position = Vector2(90, 540)
	add_child(player)
	player.set_spawn(Vector2(90, 540))
